...
layer_x("Foreground", oCamera.x / 1.3);
layer_x("Background", oCamera.x / 1.25);
layer_x("MidBackground", oCamera.x / 1.2);
layer_x("FarBackground", oCamera.x / 1.1);

//if oShaderStart.mode_color < 0
//{
//	layer_y("BackgroundColor", 1000);
//}
